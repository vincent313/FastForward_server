...
public class MyConnection extends WebSocketServer{
    ...
    public void onOpen(WebSocket conn, ClientHandshake handshake) {
        this.wb=conn;
        Online_UserManagement_Service.addConnectedUser();
        Online_UserManagement_Service.updateConnectionLastMsgTime(this);
    ...
    public void onMessage(WebSocket conn, String message) {
        Online_UserManagement_Service.updateConnectionLastMsgTime(this);//on message update last msg time
        ...
        switch (type){
            ...
            /**发来消息是<TYPE:2> <MID:XXXXXXXXX><CONTENT:MAP<USERNAME,PASSWORD>><SIGNATURE>
